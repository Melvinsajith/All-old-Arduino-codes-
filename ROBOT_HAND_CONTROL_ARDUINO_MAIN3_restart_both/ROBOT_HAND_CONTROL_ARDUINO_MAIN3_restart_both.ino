...
delay(250);
receieveData();
if (valsRec[0] == 1){pwm.setPWM(0, 0,400);
...
if (valsRec[1] == 1){pwm.setPWM(1, 0, 400);
Serial.println("Lmax2");
}
else(pwm.setPWM(1, 0, 100));
if (valsRec[2] == 1){pwm.setPWM(2, 0, 400);
Serial.println("Lmax3");

}
else(pwm.setPWM(2, 0, 100));
if (valsRec[3] ==1){pwm.setPWM(3, 0, 400);
Serial.println("Lmax4");

}
else(pwm.setPWM(3, 0, 100));
if (valsRec[4] ==1){pwm.setPWM(4, 0, 400);
...
if (valsRec2[0] == 1){pwm.setPWM(5, 0, 400);
...
if (valsRec2[1] == 1){pwm.setPWM(6, 0, 400);
Serial.println("Rmax2");
}
else(pwm.setPWM(6, 0, 100));
if (valsRec2[2] == 1){pwm.setPWM(7, 0, 400);
Serial.println("Rmax3");

}
else(pwm.setPWM(7, 0, 100));
if (valsRec2[3] ==1){pwm.setPWM(8, 0,400);
Serial.println("Rmax4");

}
else(pwm.setPWM(8, 0, 100));
if (valsRec2[4] ==1){pwm.setPWM(9, 0, 400);
